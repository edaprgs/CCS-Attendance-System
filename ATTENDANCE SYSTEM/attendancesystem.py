...
class AttendanceSystemApp(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        self.title("Event Attendance Management System")
...
#**************************************************************** MAIN WINDOW ****************************************************************#
    # BACKGROUND 
        ...
        self.eventbtn = customtkinter.CTkButton(self.mainframe,text="COURSES",text_color="white",font=("Tahoma",16),width=100,height=40,fg_color="gray10",hover_color="gray15",command=self.coursecom)
        ...
        self.coursebtn = customtkinter.CTkButton(self.mainframe,text="EVENTS",text_color="white",font=("Tahoma",16),width=100,height=40,fg_color="gray10",hover_color="gray15",command=self.eventcom)
        self.coursebtn.place(x=290,y=30)
        self.label2 =customtkinter.CTkLabel(self.mainframe,text="EVENT ATTENDANCE MANAGEMENT SYSTEM",text_color="papaya whip",font=("Helvetica",38,"bold"))
        self.label2.place(x=55,y=150)
        self.label3 =customtkinter.CTkLabel(self.mainframe,text="Attendance made easy: Effortlessly manage and track with simplicity!",text_color="white",font=("Helvetica",25,"bold"))
        self.label3.place(x=55,y=200)
        self.label4 =customtkinter.CTkLabel(self.mainframe,text="PARTICIPATE IN EVENTS",text_color="lightgoldenrod3",font=("Rowdies",50,"bold"))
        self.label4.place(x=55,y=320)
