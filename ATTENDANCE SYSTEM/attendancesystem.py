...
# TABLE
    tablestyle()
    etable = ttk.Treeview(tabview.tab("EVENTS LIST"))
    y_scroll = customtkinter.CTkScrollbar(etable,orientation=VERTICAL,button_color="lightgoldenrod4",button_hover_color="lightgoldenrod3")
    ...
    etable.place(x=55,y=125,width=1000,height=360)
# BUTTONS
...
# TABLE
    tablestyle()
    stable = ttk.Treeview(tabview.tab("STUDENTS LIST"))
    y_scroll = customtkinter.CTkScrollbar(stable,orientation=VERTICAL,button_color="lightgoldenrod4",button_hover_color="lightgoldenrod3")
    ...
    stable.place(x=50,y=125,width=1005,height=360)
# BUTTONS
...
# TABLE
    tablestyle()
    ctable = ttk.Treeview(tabview.tab("COURSES LIST"))
    y_scroll = customtkinter.CTkScrollbar(ctable,orientation=VERTICAL,button_color="lightgoldenrod4",button_hover_color="lightgoldenrod3")
    ...
    ctable.place(x=50,y=120,width=1000,height=290)
# BUTTONS
